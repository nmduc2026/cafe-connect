...
|---|---|---|---|
| [0](phase-00-setup.md) | Khởi tạo dự án & môi trường | 3–4h | `docker compose up` → Laravel API + Vue chạy, gọi được `/api/health` |
...
- [ ] Code chạy được bằng `docker compose up` từ máy sạch
